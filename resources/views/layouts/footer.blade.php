            ...
            <div class="max-w-7xl mx-auto px-6 py-12 grid grid-cols-1 md:grid-cols-4 gap-10">
                ...
                <div>
                    ...
                    <p class="text-gray-200 text-sm leading-relaxed mb-4">
                        Perumdam Tirta Mukti melayani penyediaan air bersih di Kabupaten Cianjur, Kecamatan Cianjur, dan Kota Cianjur dengan komitmen pelayanan terbaik dan berkelanjutan.
                    </p>
                ...
                <div>
                    ...
                    <ul class="text-gray-200 text-sm space-y-2">
                        <li>📍 Jl. Pangeran Hidayatullah, Limbangansari, kecamatan Cianjur, Kabupaten Cianjur, Jawa Barat 43211</li>
                        <li>📞 (0263) 261157</li>
