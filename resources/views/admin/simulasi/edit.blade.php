<x-admin-layout>
    <div class="max-w-4xl mx-auto py-10 px-6 mt-40">
        ...
        <div class="bg-white rounded-xl shadow-md p-8 border border-blue-100">
            <h3 class="text-lg font-semibold text-blue-700 mb-6 border-b pb-2">💧 Formulir Edit Data Simulasi</h3>

            <form action="{{ route('admin.simulasi.update', $simulasi->id) }}" method="POST" class="space-y-6">
                @csrf
                @method('PUT')
                ...
                <div>
                    ...
                    <input type="text" name="golongan"
                           value="{{ old('golongan', $simulasi->golongan) }}"
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="number" name="tarif_0_10"
                               value="{{ old('tarif_0_10', $simulasi->tarif_0_10) }}"
                               class="w-full border border-blue-200 rounded-lg px-4 py-2 focus:ring-blue-500 focus:border-blue-500"
                    ...
                    <div>
                        ...
                        <input type="number" name="tarif_11_20"
                               value="{{ old('tarif_11_20', $simulasi->tarif_11_20) }}"
                               class="w-full border border-blue-200 rounded-lg px-4 py-2 focus:ring-blue-500 focus:border-blue-500"
                               placeholder="Masukkan tarif..." required>
                    </div>
                    ...
                    <div>
                        ...
                        <input type="number" name="tarif_21"
                               value="{{ old('tarif_21', $simulasi->tarif_21) }}"
                               class="w-full border border-blue-200 rounded-lg px-4 py-2 focus:ring-blue-500 focus:border-blue-500"
                               placeholder="Masukkan tarif..." required>
                    </div>
                    ...
                    <div>
                        ...
                        <input type="number" name="biaya_admin"
                               value="{{ old('biaya_admin', $simulasi->biaya_admin) }}"
                               class="w-full border border-blue-200 rounded-lg px-4 py-2 focus:ring-blue-500 focus:border-blue-500"
