<x-admin-layout>
    <div class="max-w-4xl mx-auto py-10 px-6 mt-40">
        ...
        <div class="bg-white rounded-xl shadow-md p-8 border border-blue-100">
            <h3 class="text-lg font-semibold text-blue-700 mb-6 border-b pb-2">✏️ Formulir Edit Partner</h3>

            <form action="{{ route('admin.partner.update', $partner->id) }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                @csrf
                @method('PUT')
                ...
                <div>
                    ...
                    @if($partner->logo)
                        <img src="{{ asset('storage/' . $partner->logo) }}"
                             class="w-40 h-24 object-contain mb-3 rounded-lg shadow border border-blue-100">
                    @endif
